...
[System.Serializable]
public class DecreaseBasicPowerEffect : CoinEffect
{
    [SerializeField] private int DecreaseBasicPowerStack;
    ...
    public override void Execute(BattleActionContext battleAction, SkillCoinOS coin, int coinPower)
    {
        ...
        DecreaseBasicPower decreaseBasicPower = new DecreaseBasicPower();
        decreaseBasicPower.SetDecreaseBasicPowerStack(DecreaseBasicPowerStack);

        switch (turnSet)
        {
            case EffectTurnSet.This:
                targetManager.AddEffect(decreaseBasicPower);
                break;
            case EffectTurnSet.Next:
                targetManager.AddEffectNextTurn(decreaseBasicPower);
                break;
